...
class RegisterForm(forms.Form):
    emp_id = forms.IntegerField(error_messages={'required': '직원번호를 을 입력해주세요.'},
                                label='직원번호')
    emp_name = forms.CharField(error_messages={'required': '직원이름을 입력해주세요.'},
                               label='직원이름')
...
class LoginForm(forms.Form):
    ...
    emp_id = forms.IntegerField(error_messages={'required': '직원번호를 입력해주세요.'},
                                label='직원번호')
    password = forms.CharField(error_messages={'required': '비밀번호를 입력해주세요.'},
                               widget=forms.PasswordInput,
                               label='비밀번호')
